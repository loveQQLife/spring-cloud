...
public class ScaleImage {
	...
	public void saveImage(MultipartFile fromFileStr, String saveToFileStr, String extName, int formatWideth, int formatHeight) throws Exception {
		BufferedImage srcImage;
		File saveFile = new File(saveToFileStr);
		srcImage = ImageIO.read(fromFileStr.getInputStream()); // construct image
